...
class HhVacancyConstructor(VacancyConstructor):
    ...
    def return_vacancy_list_from_json_list(self, vacancy_json: list[dict]) -> list[Vacancy]:
        ...
        for elem in vacancy_json:
            ...
            salary = elem['salary']#'(elem['salary']['from'], elem['salary']['to'])  salary': {'from': 100000, 'to': 150000, 'currency': 'RUR', 'gross': False}, !!!!ЗАРПЛАТА!!!!
            ...
            requirements = elem['snippet']['requirement']

class Vacancy:
    ...
    """
    __slots__ = ('__name', '__url', '__salary', '__wtf')

    def __init__(self, name: str, url: str, salary: str, wtf: str):
        valid_data = self.validation(name = name, url=url, salary = salary, wtf = wtf)
        self.__name = name
        self.__url = url
